...
public class MojeKontaktyFragment extends ListFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        inputFind.addTextChangedListener(new TextWatcher(){
            public void afterTextChanged(Editable s) {            	
            	...
            	//toto ak mam vyhladavaci text v edittexte inputFind zhodi aplikaciu pri zmene orientacie ??? nejako zabezpecit aby to nerobil
            	//ked je zmena orientacie	
                vylistuj();
            	}
	...
	//koniec onactivitycreted
		...
		//broadcastreceiver na prenos z fragmentu MojKontaktDetailFragment
		String KeyWord;
		public static final String ACTION_INTENT = "com.eusecom.snowsmsden.action.VYPIS_UPDATE";
	    protected BroadcastReceiver receiver = new BroadcastReceiver() {

	        @Override
	        public void onReceive(Context context, Intent intent) {
	            if(ACTION_INTENT.equals(intent.getAction())) {
	                String value = intent.getStringExtra("VYPIS_KEY");
	    ...
	    private void updateUIOnReceiverValue(String value) {
	        //sem dam co chcem robit
	        //inputSend.setText(value);
	    	if( value.equals("znovulistujpoupdate")) {
	    		vylistuj();
	    		}
	    	if( value.equals("znovulistujpodelete")) {
		        vylistuj();
		    	}
	    }
	    ...
	    //koniec broadcastreceiver na prenos z fragmentu MojKontaktDetailFragment
